 ...
 * tools registered with the SJ MCP server (per `extensions/syntropy/openclaw.plugin.json`
 ...
 * match — and the schema-coupling risk register (parent monorepo issue
 * #44) flags this as a tracked drift surface.
 *
 * Schemas are checked at the TypeBox shape level (presence + types only).
 */
