...
describe("B-Twilio-1 rails — register() wiring (slice 6)", () => {
  it("registers the 'sms' channel, webhook + cleanup — ONLY under the SYN-272 R1 smsEnabled flag", async () => {
    ...
    (api.pluginConfig as Record<string, unknown>).smsEnabled = true; // SYN-272 R1 flag
